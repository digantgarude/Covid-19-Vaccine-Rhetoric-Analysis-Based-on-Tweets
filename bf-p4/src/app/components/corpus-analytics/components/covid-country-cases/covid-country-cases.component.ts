...
@Component({
  selector: 'app-covid-country-cases',
  templateUrl: './covid-country-cases.component.html',
  styleUrls: ['./covid-country-cases.component.scss']
})
export class CovidCountryCasesComponent implements OnInit {
...
//   });
  ...
  async dataFill(data:any){
      this.options = {
          ...
          title: {
              text: this.selected_poi_country+' # of cases rise | Covid 19',
              align: 'left'
          },
          xAxis: [{
